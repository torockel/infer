...
Note that the remainder of this vignette has been adapted into an interactive `learnr` lesson available by running `learnr::run_tutorial("infer", package = "infer")`.

Throughout this vignette, we make use of `gss`, a dataset supplied by `infer` containing a sample of 3000 observations of 11 variables from the *General Social Survey*. 
